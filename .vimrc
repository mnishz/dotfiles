...
" ‚¤‚Á‚©‚è‰üs‚µ‚Ä‚µ‚Ü‚Á‚½‚Æ‚«‚ÉƒCƒ“ƒfƒ“ƒg‚ğ‚·‚×‚ÄÁ‚·
" <c-o>‚¾‚Æundo‚ª‚¨‚©‚µ‚­‚È‚é
...
"   " ‘g‚İ‚İŠÖ”(functions)‚â©ìŠÖ”‚ğ'’¼Ú'ŒÄ‚Ño‚·‚Æ‚«‚É‚Ícall‚ğg‚¤
...
function! s:GetGitRootPath(...)
  ...
  " ‰½ŒÌ‚© current directory (:pwd) ‚ÅŒ©‚¦‚é path ‚É '.git' ‚ª‘¶İ‚·‚éê‡A
  " finddir('.git', 'W:\;') ‚ª‹ó‚Å‚È‚¢’l‚ğ•Ô‚·‚æ‚¤‚ÉŒ©‚¦‚éB
  " ‚È‚ñ‚© 'w:\' ‚ª‚¤‚Ü‚­‹@”\‚µ‚Ä‚¢‚È‚¢‚æ‚¤‚ÉŒ©‚¦‚éB'\'‚¾‚ÆŠú‘Ò’Ê‚è‚ÌŒ‹‰Ê‚ªo‚éB

  " echo finddir('.git', 'W:\')  Šú‘Ò‚Ç‚¨‚è
  " echo finddir('.git', 'W:\;') ãˆÊƒfƒBƒŒƒNƒgƒŠŠÖŒW‚È‚­’P‚ÉƒJƒŒƒ“ƒgƒfƒBƒŒƒNƒgƒŠ‚Ì’l‚ğ•Ô‚µ‚Ä‚¢‚é‚æ‚¤‚ÉŒ©‚¦‚é
  " echo finddir('.git', '\')    Šú‘Ò‚Ç‚¨‚è
  " echo finddir('.git', '\;')   ãˆÊƒfƒBƒŒƒNƒgƒŠŠÖŒW‚È‚­’P‚ÉƒJƒŒƒ“ƒgƒfƒBƒŒƒNƒgƒŠ‚Ì’l‚ğ•Ô‚µ‚Ä‚¢‚é‚æ‚¤‚ÉŒ©‚¦‚é
  " •’Ê‚Ìc drive‚Å‚à“¯‚¶‚©‚Ç‚¤‚©Šm”F‚µ‚½‚¢
  " Linux‚Å‚Ì '/;' ‚Í³‚µ‚­“®‚¢‚Ä‚¢‚é‚æ‚¤‚ÉŒ©‚¦‚é
