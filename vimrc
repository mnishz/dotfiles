...
" この上の部分で意図していることがよく分からないが、これでtagsを上に辿ってくれるらしい。
set tags=./tags;
...
" カーソルラインをハイライト
" gvimrcに、ハイライトではなくアンダーラインを引くための追加の設定があるが、結局やめた
set cursorline

" (:bro olで表示される)ファイルの履歴を30までに制限する。その他はデフォルトの設定を残した。
